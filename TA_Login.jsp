...
<head>
<title>Blockchain Blockchain Login</title>
...
<div class="main">
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="TA_Login.jsp"><span>Blockchain</span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Blockchain Login  </span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="article">
            <form action="TA_Authentication.jsp" method="post" id="leavereply">
              <label for="name"><br />
                <span class="style1"><img src="images/blockchain.png" alt="Centered Image" /><br />
                <br />
          ...
          <div class="g2">
            <div class="gadget">
              ...
              <ul class="sb_menu">
                ...
                <li><a href="TA_Login.jsp">Blockchain</a></li>
              </ul>
            </div>
          </div>
        </div>
