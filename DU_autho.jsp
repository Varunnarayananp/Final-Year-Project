...
for Cloud Based Digital Twin Environment
      ...
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="DU_autho.jsp"><span>Home </span></a></li>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="article">
            <p class="style1">&nbsp;</p>
            <p class="style1"><span class="style3"> <span class="style4">You Are</span> Not Authorized !!</span> Wait For Authorization 
              .            </p>
            <p align="justify">&nbsp;</p>
            <p align="right"><a href="DU_Login.jsp"></a></p>
          </div>
          <div class="clr"></div>
        </div>
      </div>
        ...
        <div class="g1">
          <div class="g2">
            <div class="gadget">
              ...
              <div class="clr"></div>
              <ul class="sb_menu">
                <li><a href="DU_autho.jsp">Home</a></li>
