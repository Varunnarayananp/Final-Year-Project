...
<head>
<title>CS_View_Impersonation_Attacks_Result</title>
...
for Cloud Based Digital Twin Environment
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>View Impersonation Attacks Results </span></h2>
          <p class="infopost">&nbsp;</p>
         <iframe src="Results1.jsp" style="border:3px;" width="650" height="500"></iframe>
		  <li><a href="CS_Main.jsp">Back </a></li>
          <div class="clr"></div>
        </div>
      </div>
      <div class="sidebar">
