...
for Cloud Based Digital Twin Environment
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>View Authorize Data Users </span>!!!</h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="article">
		...
		%>
              <tr>
                <td height="85"><div align="center">
                    <input  name="image" type="image" src="profileimage.jsp?imgid=<%=i%>" width="80" height="80" alt="Submit" />
                </div></td>
                <td><div align="center" class="style17"><%=s1%></div></td>
                ...
                <%
						...
						{
							%>
                <td><div align="center" class="style17"><a href="CS_DUStatus.jsp?id=<%=i%>"><%=s5%></div></td>
                <%
						}
						else
						{
							%>
                <td width="32"><div align="center" class="style17"><%=s5%></div></td>
                <%
						}	
	   }
           connection.close();
