    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="img"><img src="images/cloud.jpg" alt="Centered Image" class="fl" /></div>
          <div class="post_content">
            <p align="justify" class="style1"></p>
            <p class="spec">After a mutual key agreement, the
...
data with the user after the user-owner mutual authentication. It also uploads hash values of log and stored data
to the blockchain.&nbsp;</p>
          </div>
          <div class="clr"></div>
        </div>
          ...
          <div class="g2">
            <div class="gadget">
              ...
              <ul class="sb_menu">
				...
				<li><a href="CS_DUAuthorize.jsp">View Data Users and Authorization </a></li>
				<li><a href="CS_DOAuthorize.jsp">View Data Owner and Authorization </a></li>
				
				<li><a href="CS_View_All_Datasets.jsp">View All Datasets</a></li>
				
				<li><a href="CS_AttReq.jsp">View All Data Requests</a></li>
				<li><a href="CS_View_Impersonation_Attacks_Result.jsp">View Impersonation Attacks Results </a></li>
